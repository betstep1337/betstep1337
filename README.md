...
- Первый сервер запустил для друзей → ушёл в глубокую техническую сторону  
- Пишу **кастомные плагины** под **Paper/Spigot 1.16+** на Java (Kotlin — редко, по запросу)  
- Работал **тех. админом** и **разработчиком** на разных проектах
- Все заказы — **только с положительными отзывами**
